...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/tinyblack9858/", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "小黑",
	bio: "Nobody knows everything,but everybody knows something.",
	links: [
		{
			name: "Telegram",
			icon: "fa6-brands:telegram",
			url: "https://t.me/zyc9858",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/tinyblack9858/tinyblack.github.io",
		},
	],
};
